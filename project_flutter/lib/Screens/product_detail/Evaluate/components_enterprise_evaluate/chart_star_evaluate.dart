...
class ChartStar_Enterprise extends StatelessWidget {
  final String productName;
  final int SumEvaluate;

  late final List<StarLine> listEarnings;
  ChartStar_Enterprise({required this.listEarnings, required this.productName, required this.SumEvaluate});
      ...
      child: Card(
        child: Padding(
          ...
          child: Column(
            children: <Widget>[
              Text(
                "Biểu đồ đánh giá Cửa hàng " + productName,
