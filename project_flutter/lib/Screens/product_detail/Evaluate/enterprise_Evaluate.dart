...
import 'package:project_flutter/Screens/product_detail/Evaluate/components_enterprise_evaluate/chart_star_evaluate.dart';
...
import 'components_enterprise_evaluate/enterprise_comments_list.dart';
import 'components/product_comments_list.dart';



class EnterpriseEvaluateScreen extends StatefulWidget {
  const EnterpriseEvaluateScreen({Key? key, required this.id}) : super(key: key);

  final String id;

  @override
  _EnterpriseEvaluateScreenState createState() => _EnterpriseEvaluateScreenState();
}

class _EnterpriseEvaluateScreenState extends State<EnterpriseEvaluateScreen> {
        ...
        body: Container(
          ...
          child: Column(
            children: [
              ...
              //),
              Expanded(
                child: ChartStar_Enterprise(productName: product.name, listEarnings: listEarnings, SumEvaluate: 71,),
              ),
              Expanded(
                child: CommentEnterprise(product: product, id: widget.id,),
              ),
            ],
          ),
        ),
